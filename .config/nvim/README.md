...
| `цц` | быстро сохранить файл в русской раскладке |
| `qq` | закрыть текущий буфер и перейти на соседний |
| `йй` | закрыть текущий буфер в русской раскладке |
...
| `оо` | выйти из insert mode в русской раскладке |
...
| `ол` | выйти в normal mode терминала в русской раскладке |
| `Ctrl-h` | окно слева |
| `Ctrl-j` | окно снизу |
| `Ctrl-k` | окно сверху |
| `Ctrl-l` | окно справа |
