...
function M.apply_general(map, terminal)
    ...
    M.map_leader(map, 'ее', function() terminal.toggle(terminal.ids.main, "bottom") end)
    M.map_leader(map, 'еа', function() terminal.toggle(terminal.ids.float, "float") end)
    M.map_leader(map, 'ер', function() terminal.toggle(terminal.ids.main, "bottom") end)
    M.map_leader(map, 'ем', function() terminal.toggle(terminal.ids.right, "right") end)
    M.map_leader(map, '1', function() terminal.toggle(terminal.ids.main, "bottom") end)
    M.map_leader(map, '2', function() terminal.toggle(terminal.ids.bottom_2, "bottom") end)
    M.map_leader(map, '3', function() terminal.toggle(terminal.ids.bottom_3, "bottom") end)
    M.map_leader(map, '4', function() terminal.toggle(terminal.ids.float, "float") end)
