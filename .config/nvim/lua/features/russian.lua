...
function M.apply_general(map, terminal)
    ...
    M.map_leader(map, 'е1', function() terminal.toggle(terminal.ids.main, "bottom") end)
    M.map_leader(map, 'е2', function() terminal.toggle(terminal.ids.bottom_2, "bottom") end)
    M.map_leader(map, 'е3', function() terminal.toggle(terminal.ids.bottom_3, "bottom") end)
    M.map_leader(map, 'е4', function() terminal.toggle(terminal.ids.float, "float") end)
