...
map('n', '<leader>tt', function() terminal.toggle(terminal.ids.main, "bottom") end)
map('n', '<leader>tf', function() terminal.toggle(terminal.ids.float, "float") end)
map('n', '<leader>th', function() terminal.toggle(terminal.ids.main, "bottom") end)
map('n', '<leader>tv', function() terminal.toggle(terminal.ids.right, "right") end)
map('n', '<C-\\>', function() terminal.toggle(terminal.ids.main, "bottom") end)
map('n', '<leader>1', function() terminal.toggle(terminal.ids.main, "bottom") end)
map('n', '<leader>2', function() terminal.toggle(terminal.ids.bottom_2, "bottom") end)
map('n', '<leader>3', function() terminal.toggle(terminal.ids.bottom_3, "bottom") end)
map('n', '<leader>4', function() terminal.toggle(terminal.ids.float, "float") end)
